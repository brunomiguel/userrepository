...
class HtmlBuilder {
  ...
  async build(metadata, rawReports) {
    ...
    await (0, _fileUtils.copyFileAndMakeWritable)(_path.default.join(appFolder, 'index.html'), _path.default.join(this._reportFolder, 'index.html'));
    ...
    if (this._hasTraces) {
      ...
      for (const file of _fs.default.readdirSync(traceViewerFolder)) {
        ...
        await (0, _fileUtils.copyFileAndMakeWritable)(_path.default.join(traceViewerFolder, file), _path.default.join(traceViewerTargetFolder, file));
      }
    }
