...
exports.addEventDefaults = exports.SDK_NAME = exports.SDK_VERSION = void 0;
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fs_1.readDirAsync('/etc')];
                case 2:
                    etcFiles_1 = _a.sent();
                    ...
                    distroPath = path_1.join('/etc', distroFile.name);
                    return [4 /*yield*/, fs_1.readFileAsync(distroPath, { encoding: 'utf-8' })];
                case 3:
...
function getEventDefaults(appName) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    name = appName || common_1.getNameFallback();
                    _a = {};
                    _b = {
                        app: {
                            app_name: name,
                ...
                case 1: return [2 /*return*/, (_a.contexts = (_b.os = (_c.sent()),
                        ...
                        _a.release = name.replace(/\W/g, '-') + "@" + electron_1.app.getVersion(),
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    _b = _d.sent(), _c = _b.contexts, defaultContexts = _c === void 0 ? {} : _c, defaults = tslib_1.__rest(_b, ["contexts"]);
                    // Perform a manual deep merge of the defaults with the event data.
                    // TODO: Use a proper deep merge here, instead.
                    return [2 /*return*/, tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, defaults), event), { sdk: {
                                ...
                                version: exports.SDK_VERSION,
                            }, contexts: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, defaultContexts), contexts), { app: tslib_1.__assign(tslib_1.__assign({}, defaultContexts.app), contexts.app), device: tslib_1.__assign(tslib_1.__assign({}, defaultContexts.device), contexts.device), os: tslib_1.__assign(tslib_1.__assign({}, defaultContexts.os), contexts.os), runtime: tslib_1.__assign(tslib_1.__assign({}, defaultContexts.runtime), contexts.runtime) }), extra: tslib_1.__assign(tslib_1.__assign({}, defaults.extra), event.extra), user: tslib_1.__assign(tslib_1.__assign({}, defaults.user), event.user) })];
            }
        });
    });
}
