...
function getScope() {
    ...
    return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, (hasKeys(scope._user) && { user: scope._user })), (hasKeys(scope._tags) && { tags: scope._tags })), (hasKeys(scope._extra) && { extra: scope._extra }));
}
...
var MainBackend = /** @class */ (function (_super) {
    ...
    MainBackend.prototype._setupScopeListener = function () {
        ...
        if (hubScope) {
            hubScope.addScopeListener(function (updatedScope) {
                var scope = core_1.Scope.clone(updatedScope);
    ...
    MainBackend.prototype._updateExtraParams = function (scope) {
        ...
        utils_1.forget(this._getNativeUploaderEvent(scope).then(function (event) {
            var e_1, _a;
            ...
            try {
                for (var _b = tslib_1.__values(Object.keys(mainParams)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var key = _c.value;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        // Apply the scope to the event
                        _a.sent();
                        return [4 /*yield*/, context_1.addEventDefaults(this._options.appName, event)];
                    case 2:
                        // Add all the extra context
                        event = _a.sent();
                        return [2 /*return*/, normalize_1.normalizeEvent(event)];
                }
            });
        });
    };
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                if (this._options.useSentryMinidumpUploader !== false) {
                    crashesDirectory = electron_version_1.supportsGetPathCrashDumps()
                ...
                electron_1.app.on('web-contents-created', function (_, contents) {
                    if (electron_version_1.supportsRenderProcessGone()) {
    ...
    MainBackend.prototype._installIPC = function () {
        var _this = this;
        electron_1.ipcMain.on(common_1.IPC.PING, function (event) {
            event.sender.send(common_1.IPC.PING);
        });
        electron_1.ipcMain.on(common_1.IPC.EVENT, function (ipc, jsonEvent) {
            var event;
            try {
        ...
        electron_1.ipcMain.on(common_1.IPC.SCOPE, function (_, jsonRendererScope) {
            var rendererScope;
            try {
