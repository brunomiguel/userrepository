...
exports.buildFailureTestResult = exports.parseMessage = exports.makeMessage = exports.parseJSON = exports.MESSAGE_TYPES = exports.getIPCIDs = exports.validateIPCID = exports.makeUniqWorkerId = exports.makeUniqServerId = exports.invariant = exports.rand = undefined;
...
const makeMessage = (exports.makeMessage = ({messageType, data}) =>
  `${messageType}-${data || ''}`);
...
const buildFailureTestResult = (exports.buildFailureTestResult = (
  ...
  const failureMessage = (0, _jestMessageUtil.formatExecError)(
    err,
    config,
    globalConfig
  );
