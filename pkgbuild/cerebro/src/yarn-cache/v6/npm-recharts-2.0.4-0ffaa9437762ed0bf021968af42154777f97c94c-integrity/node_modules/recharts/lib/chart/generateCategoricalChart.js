    ...
    function CategoricalChartWrapper(_props) {
      ...
      _this.renderGraphicChild = function (element, displayName, index) {
        ...
        var itemEvents = isTooltipTriggerByClick ? {
          onClick: (0, _ChartUtils.combineEventHandlers)(_this.handleItemMouseEnter, null, item.props.onCLick)
        } : {
          onMouseLeave: (0, _ChartUtils.combineEventHandlers)(_this.handleItemMouseLeave, null, item.props.onMouseLeave),
          onMouseEnter: (0, _ChartUtils.combineEventHandlers)(_this.handleItemMouseEnter, null, item.props.onMouseEnter)
        };
