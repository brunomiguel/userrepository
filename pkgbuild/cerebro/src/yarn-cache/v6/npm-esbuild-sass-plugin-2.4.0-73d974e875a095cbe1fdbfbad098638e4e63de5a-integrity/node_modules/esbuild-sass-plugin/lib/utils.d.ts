...
export declare function postcssModules(options: PostcssModulesParams, plugins?: AcceptedPlugin[]): (this: SassPluginOptions, source: string, dirname: string, path: string) => Promise<OnLoadResult>;
