...
exports.default = exports._store = exports._setup = exports._baseTest = void 0;
...
const playwrightFixtures = {
  ...
  _combinedContextOptions: async ({
    ...
    if (_storageStateName !== undefined) {
      ...
      if (!value) throw new Error(`Cannot find value in the _store for _storageStateName: "${_storageStateName}"`);
  ...
  _contextFactory: [async ({
    ...
    const prependToError = testInfo._didTimeout ? formatPendingCalls(browser._connection.pendingProtocolCalls()) : '';
    let counter = 0;
...
exports.test = test;
const _setup = _baseTest.extend(playwrightFixtures);
exports._setup = _setup;
(0, _testType._setProjectSetup)(_setup, true);
var _default = test;
